...
// externs from d/hapi v15/index.d.ts:
 ...
 * @struct
 */
function IHeaderOptions() {}
 /** @type {boolean} */
IHeaderOptions.prototype.append;
 /** @type {string} */
IHeaderOptions.prototype.separator;
 /** @type {boolean} */
IHeaderOptions.prototype.override;
 /** @type {boolean} */
IHeaderOptions.prototype.duplicate;
/**
 * @record
 * @struct
 */
 ...
 * @struct
 */
function ICatBoxCachePolicyOptions() {}
 /** @type {string} */
ICatBoxCachePolicyOptions.prototype.cache;
 /** @type {string} */
ICatBoxCachePolicyOptions.prototype.segment;
 /** @type {boolean} */
ICatBoxCachePolicyOptions.prototype.shared;
 /** @type {number} */
ICatBoxCachePolicyOptions.prototype.expiresIn;
 /** @type {number} */
ICatBoxCachePolicyOptions.prototype.expiresAt;
 /** @type {!Function} */
ICatBoxCachePolicyOptions.prototype.generateFunc;
 /** @type {number} */
ICatBoxCachePolicyOptions.prototype.staleIn;
 /** @type {number} */
ICatBoxCachePolicyOptions.prototype.staleTimeout;
 /** @type {number} */
ICatBoxCachePolicyOptions.prototype.generateTimeout;
 /** @type {boolean} */
ICatBoxCachePolicyOptions.prototype.dropOnError;
 /** @type {boolean} */
ICatBoxCachePolicyOptions.prototype.generateOnReadError;
 /** @type {boolean} */
ICatBoxCachePolicyOptions.prototype.generateIgnoreWriteError;
 /** @type {number} */
ICatBoxCachePolicyOptions.prototype.pendingGenerateTimeout;
/**
 * @extends {IConnectionConfigurationServerDefaults}
 * @record
 * @struct
 */
function IServerConnectionOptions() {}
 /** @type {string} */
IServerConnectionOptions.prototype.host;
 /** @type {string} */
IServerConnectionOptions.prototype.address;
 /** @type {(string|number)} */
IServerConnectionOptions.prototype.port;
 /** @type {string} */
IServerConnectionOptions.prototype.uri;
 /** @type {?} */
IServerConnectionOptions.prototype.listener;
 /** @type {boolean} */
IServerConnectionOptions.prototype.autoListen;
 /** @type {?} */
IServerConnectionOptions.prototype.cache;
 /** @type {(string|!Array<string>)} */
IServerConnectionOptions.prototype.labels;
 /** @type {(boolean|!Object|?)} */
IServerConnectionOptions.prototype.tls;
/**
 * @record
 * @struct
 */
...
IConnectionConfigurationServerDefaults.prototype.app;
 /** @type {boolean} */
IConnectionConfigurationServerDefaults.prototype.compression;
 /** @type {?} */
 ...
 * @return {?}
 */
IReplyMethods.prototype.header = function(name, value, options) {};
 ...
 * @return {?}
 */
IReplyMethods.prototype.response = function(result) {};
 ...
 * @return {void}
 */
IReplyMethods.prototype.state = function(name, value, options) {};
 ...
 * @return {void}
 */
IReplyMethods.prototype.unstate = function(name, options) {};
/**
 ...
 * @return {void}
 */
IProxyHandlerConfig.prototype.mapUri = function(request, callback) {};
 ...
 * @return {void}
 */
IProxyHandlerConfig.prototype.onResponse = function(err, res, req, reply, settings, ttl) {};
/**
 * @record
 * @struct
 */
...
IRouteAdditionalConfigurationOptions.prototype.tags;
 /** @type {boolean} */
IRouteAdditionalConfigurationOptions.prototype.log;
/**
 * @record
 * @struct
 */
function IRouteAdditionalConfigurationAuthAccess() {}
 /** @type {(string|boolean|!Array<string>)} */
IRouteAdditionalConfigurationAuthAccess.prototype.scope;
 /** @type {string} */
IRouteAdditionalConfigurationAuthAccess.prototype.entity;

/** @typedef {?} */
var IRouteAdditionalConfigurationCache;
/**
 * @record
 * @struct
 */
 ...
 * @struct
 */
function IServerInjectResponse() {}
 /** @type {number} */
IServerInjectResponse.prototype.statusCode;
 /** @type {?} */
IServerInjectResponse.prototype.headers;
 /** @type {string} */
IServerInjectResponse.prototype.payload;
 /** @type {?} */
IServerInjectResponse.prototype.rawPayload;
 /** @type {?} */
IServerInjectResponse.prototype.raw;
 /** @type {?} */
IServerInjectResponse.prototype.result;
 /** @type {?} */
IServerInjectResponse.prototype.request;
/**
 * @record
 * @struct
 */
 ...
 * @struct
 */
function IServerInjectOptions() {}
 /** @type {string} */
IServerInjectOptions.prototype.method;
 /** @type {string} */
IServerInjectOptions.prototype.url;
 /** @type {?} */
IServerInjectOptions.prototype.headers;
 /** @type {(string|!Object|?)} */
IServerInjectOptions.prototype.payload;
 /** @type {?} */
IServerInjectOptions.prototype.credentials;
 /** @type {?} */
IServerInjectOptions.prototype.artifacts;
 /** @type {?} */
IServerInjectOptions.prototype.app;
 /** @type {?} */
IServerInjectOptions.prototype.plugins;
 /** @type {boolean} */
IServerInjectOptions.prototype.allowInternals;
 /** @type {boolean} */
IServerInjectOptions.prototype.remoteAddress;
 /** @type {?} */
IServerInjectOptions.prototype.simulate;
/**
 * @record
 * @struct
 */
 ...
 * @return {void}
 */
ICookieSettings.prototype.autoValue = function(request, next) {};
/**
 * @record
 * @struct
 */
 ...
 * @struct
 */
function IServerConnectionInfo() {}
 /** @type {string} */
IServerConnectionInfo.prototype.id;
 /** @type {number} */
IServerConnectionInfo.prototype.created;
 /** @type {number} */
IServerConnectionInfo.prototype.started;
 /** @type {number} */
IServerConnectionInfo.prototype.port;
 /** @type {string} */
IServerConnectionInfo.prototype.host;
 /** @type {string} */
IServerConnectionInfo.prototype.address;
 /** @type {string} */
IServerConnectionInfo.prototype.protocol;
 /** @type {string} */
IServerConnectionInfo.prototype.uri;
/**
 * @constructor
 * @struct
 */
function ServerConnection() {}
 /** @type {?} */
ServerConnection.prototype.domain;
 /** @type {?} */
ServerConnection.prototype._events;
 /** @type {number} */
ServerConnection.prototype._eventsCount;
 /** @type {?} */
...
ServerConnection.prototype.type;
 /** @type {boolean} */
ServerConnection.prototype._started;
 /** @type {?} */
ServerConnection.prototype._connections;
 /** @type {!Function} */
ServerConnection.prototype._onConnection;
 /** @type {?} */
ServerConnection.prototype.registrations;
 /** @type {?} */
ServerConnection.prototype._extensions;
 /** @type {?} */
ServerConnection.prototype._requestCounter;
 /** @type {?} */
ServerConnection.prototype._load;
 /** @type {?} */
ServerConnection.prototype.states;
 /** @type {?} */
ServerConnection.prototype.auth;
 /** @type {?} */
ServerConnection.prototype._router;
 /** @type {?} */
ServerConnection.prototype.MSPluginsCollection;
 /** @type {?} */
ServerConnection.prototype.applicationCache;
 /** @type {?} */
ServerConnection.prototype.addEventListener;
 /** @type {?} */
ServerConnection.prototype.info;

/** @typedef {string} */
var RequestExtPoints;
 ...
 * }
 * });
 * @param {string|(?|!Array<?>)} name_or_methods
 * @param {?=} method
 * @param {?=} options
 * @return {void}
 */
