...
// externs from d/winjs v2/index.d.ts:
 /** @type {?} */
 ...
 * @param {!WinJS.Promise<?>} promise The promise that should complete before processing is complete.
 * 
 * @return {void}
 */
WinJS.Application.setPromise = function(promise) {};
 ...
 * @param {!CustomEvent} eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.type
 * 
 * @return {void}
 */
WinJS.Application.onbackclick = function(eventInfo) {};
...
WinJS.Binding.Template = function(element, options) {};
 /** @type {?} */
WinJS.Binding.Template.prototype.bindingInitializer;
 /** @type {boolean} */
WinJS.Binding.Template.prototype.debugBreakOnRender;
 /** @type {boolean} */
WinJS.Binding.Template.prototype.disableOptimizedProcessing;
 /** @type {!HTMLElement} */
WinJS.Binding.Template.prototype.element;
 /** @type {boolean} */
WinJS.Binding.Template.prototype.extractChild;
 /** @type {boolean} */
WinJS.Binding.Template.prototype.isDeclarativeControlContainer;
 ...
 * @param {!Array<?>} sourceProperties The path on the source object to the source class.
 * @param {!HTMLElement} dest The destination object.
 * 
 * @return {void}
 */
WinJS.Binding.addClassOneTime = function(source, sourceProperties, dest) {};
 ...
 * @param {string} oldValue The old value for the property.
 * @return {!WinJS.Promise<?>} A promise that is completed when the notifications are complete.
 * 
 */
WinJS.Binding.notify = function(name, newValue, oldValue) {};
 ...
 * @return {!WinJS.Promise<?>} An object that returns when the animation has finished.
 * 
 */
WinJS.UI.Animation.continuumForwardIn = function(incomingPage, incomingItemRoot, incomingItemContent) {};
 ...
 * 
 */
WinJS.UI.Animation.continuumForwardOut = function(outgoingPage, outgoingItem) {};
 ...
 * 
 */
WinJS.UI.Animation.continuumBackwardIn = function(incomingPage, incomingItem) {};
 ...
 * 
 */
WinJS.UI.Animation.continuumBackwardOut = function(outgoingPage) {};
 ...
 * @param {WinJS.UI.PageNavigationAnimation} currentPreferredAnimation Describes the animation the current page prefers to use.
 * @param {WinJS.UI.PageNavigationAnimation} nextPreferredAnimation Describes the animation the incoming page prefers to use.
 * @param {boolean} movingBackwards Determines whether the navigation is moving backwards
 * @return {{enter: function(): ?, exit: function(): ?}} An object that contains an exit method used for animating exiting pages and an enter method used for animating entering pages.
 * 
 */
WinJS.UI.Animation.createPageNavigationAnimation = function(currentPreferredAnimation, nextPreferredAnimation, movingBackwards) {};
 ...
 * 
 */
WinJS.UI.Animation.slideDown = function(outgoing) {};
 ...
 * 
 */
WinJS.UI.Animation.slideUp = function(outgoing) {};
 ...
 * 
 */
WinJS.UI.Animation.slideRightIn = function(page, firstIncomingElements, secondIncomingElements, thirdIncomingElements) {};
 ...
 * 
 */
WinJS.UI.Animation.slideRightOut = function(page, firstOutgoingElements, secondOutgoingElements, thirdOutgoingElements) {};
 ...
 * 
 */
WinJS.UI.Animation.slideLeftIn = function(page, firstIncomingElements, secondIncomingElements, thirdIncomingElements) {};
 ...
 * 
 */
WinJS.UI.Animation.slideLeftOut = function(page, firstOutgoingElements, secondOutgoingElements, thirdOutgoingElements) {};
 ...
 * @return {!WinJS.Promise<?>} An promise that completes when the animation has finished.
 * 
 */
WinJS.UI.Animation.turnstileForwardIn = function(incoming) {};
 ...
 * 
 */
WinJS.UI.Animation.turnstileForwardOut = function(outgoing) {};
 ...
 * 
 */
WinJS.UI.Animation.turnstileBackwardIn = function(incoming) {};
 ...
 * 
 */
WinJS.UI.Animation.turnstileBackwardOut = function(outgoing) {};
...
/** @const {number} */
WinJS.UI.GroupHeaderTapBehavior.invoke;
/** @const {number} */
WinJS.UI.GroupHeaderTapBehavior.none;
...
WinJS.UI.ObjectType = {};
/** @const {number} */
WinJS.UI.ObjectType.groupHeader;
/** @const {number} */
WinJS.UI.ObjectType.item;

/** @const */
WinJS.UI.Orientation = {};
/** @const {number} */
WinJS.UI.Orientation.horizontal;
/** @const {number} */
WinJS.UI.Orientation.vertical;

/** @const */
WinJS.UI.PageNavigationAnimation = {};
/** @const {number} */
WinJS.UI.PageNavigationAnimation.turnstile;
/** @const {number} */
WinJS.UI.PageNavigationAnimation.slide;
/** @const {number} */
WinJS.UI.PageNavigationAnimation.enterPage;
/** @const {number} */
WinJS.UI.PageNavigationAnimation.continuum;
 ...
 * @struct
 */
WinJS.UI.ILayout2 = function() {};
 /** @type {?} */
WinJS.UI.ILayout2.prototype.orientation;
 ...
 * @return {void}
 */
WinJS.UI.ILayout2.prototype.dragLeave = function() {};

/**
 * Called when the ListView initiates a drag operation.
 * @param {number} x The x-coordinate of the drag.
 * @param {number} y The y-coordinate of the drag.
 * @param {number} dragInfo An object that indicates whether the item is selected.
 * 
 * @return {void}
 */
WinJS.UI.ILayout2.prototype.dragOver = function(x, y, dragInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.ILayout2.prototype.executeAnimations = function() {};
 ...
 * @param {WinJS.Utilities.Key} pressedKey The key that was pressed.
 * @return {?} An object that describes the next item that should receive focus. It has these properties: index, type.
 * 
 */
WinJS.UI.ILayout2.prototype.getAdjacent = function(currentItem, pressedKey) {};
 ...
 * @return {?} An object that describes the item at the hit test coordinates. It has these properties: type, index.
 * 
 */
WinJS.UI.ILayout2.prototype.hitTest = function(x, y) {};
 ...
 * @param {!WinJS.UI.ILayoutSite2} site The rendering site for the layout.
 * @param {boolean} groupsEnabled Set to true if this layout supports groups; set to false if it does not.
 * 
 * @return {void}
 */
WinJS.UI.ILayout2.prototype.initialize = function(site, groupsEnabled) {};
 ...
 * @return {void}
 */
WinJS.UI.ILayout2.prototype.itemsFromRange = function(firstPixel, lastPixel) {};
 ...
 * @return {?} A Promise that executes after layout is complete, or an object that contains two Promise objects: realizedRangeComplete, layoutComplete.
 * 
 */
WinJS.UI.ILayout2.prototype.layout = function(tree, changedRange, modifiedItems, modifiedGroups) {};
 ...
 * @return {void}
 */
WinJS.UI.ILayout2.prototype.setupAnimations = function() {};
 ...
 * @return {void}
 */
WinJS.UI.ILayout2.prototype.uninitialize = function() {};
/**
 * @record
 * @struct
 */
 ...
 * @struct
 */
WinJS.UI.ILayoutSite2 = function() {};
 /** @type {number} */
WinJS.UI.ILayoutSite2.prototype.groupCount;
 /** @type {!WinJS.Promise<number>} */
WinJS.UI.ILayoutSite2.prototype.itemCount;
 /** @type {?} */
WinJS.UI.ILayoutSite2.prototype.realizedRange;
 /** @type {?} */
WinJS.UI.ILayoutSite2.prototype.tree;
 /** @type {?} */
WinJS.UI.ILayoutSite2.prototype.visibleRange;
/**
 * @record
 * @struct
 */
...
WinJS.UI.IListViewItem.prototype.type;
/**
 * @record
 * @struct
 */
...
WinJS.UI.AppBar = function(element, options) {};
 /** @type {string} */
WinJS.UI.AppBar.prototype.closedDisplayMode;
 ...
 * @return {void}
 */
WinJS.UI.AppBar.prototype.dispose = function() {};
...
WinJS.UI.AppBarCommand.prototype.extraClass;
 /** @type {!HTMLElement} */
WinJS.UI.AppBarCommand.prototype.firstElementFocus;
 /** @type {boolean} */
...
WinJS.UI.AppBarCommand.prototype.label;
 /** @type {!HTMLElement} */
WinJS.UI.AppBarCommand.prototype.lastElementFocus;
 /** @type {!Function} */
 ...
 * @return {void}
 */
WinJS.UI.AppBarCommand.prototype.dispose = function() {};
 ...
 * @return {void}
 */
WinJS.UI.FlipView.prototype.dispose = function() {};
...
/**
 * Registers an event handler for the specified event.
 * @param {string} eventName The name of the event to handle. For a list of events, see the Flyout object page.
 * @param {!Function} eventHandler The event handler function to associate with the event.
 * @param {boolean=} useCapture Set to true to register the event handler for the capturing phase; set to false to register the event handler for the bubbling phase.
 * 
 * @return {void}
 */
WinJS.UI.Flyout.prototype.addEventListener = function(eventName, eventHandler, useCapture) {};
 ...
 * @return {void}
 */
WinJS.UI.Flyout.prototype.removeEventListener = function(eventName, eventHandler, useCapture) {};
 ...
 * @return {void}
 */
WinJS.UI.Flyout.prototype.dispose = function() {};
 ...
 * @param {!HTMLElement} anchor The DOM element to anchor the Flyout.
 ...
 * @param {number|!MouseEvent} x_or_mouseEventObj The x coordinate point where the top left corner of the Flyout will appear, relative to the top and left edge of the visual viewport. / The MouseEvent Object that specifies where to show the Flyout based on its location.
 * @param {number=} y The y coordinate point where the top left corner of the Flyout will appear, relative to the top and left edge of the visual viewport.
 * @return {void}
 */
WinJS.UI.Flyout.prototype.showat = function(x_or_mouseEventObj, y) {};
...
WinJS.UI.GridLayout.prototype.itemInfo;
 /** @type {number} */
WinJS.UI.GridLayout.prototype.maximumRowsOrColumns;
 /** @type {number} */
WinJS.UI.GridLayout.prototype.maxRows;
 /** @type {?} */
WinJS.UI.GridLayout.prototype.numberOfItemsPerItemsBlock;
 /** @type {WinJS.UI.Orientation} */
WinJS.UI.GridLayout.prototype.orientation;
 ...
 * @return {void}
 */
WinJS.UI.GridLayout.prototype.dragLeave = function() {};
 ...
 * @return {void}
 */
WinJS.UI.GridLayout.prototype.dragOver = function() {};
 ...
 * @return {void}
 */
WinJS.UI.GridLayout.prototype.executeAnimations = function() {};
 ...
 * 
 */
WinJS.UI.GridLayout.prototype.getAdjacent = function(currentItem, pressedKey) {};
 ...
 * @return {void}
 */
WinJS.UI.GridLayout.prototype.initialize = function(site, groupsEnabled) {};
 ...
 * @return {void}
 */
WinJS.UI.GridLayout.prototype.layout = function(tree, changedRange, modifiedItems, modifiedGroups) {};
 ...
 * @return {void}
 */
WinJS.UI.GridLayout.prototype.setupAnimations = function() {};
 ...
 * @return {void}
 */
WinJS.UI.GridLayout.prototype.uninitialize = function() {};
 ...
 * @param {!HTMLElement=} element The DOM element hosts the new ItemContainer. For the ItemContainer to be accessible, this element must have its role attribute set to "list" or "listbox". If tapBehavior is set to none and selectionDisabled is true, then use the "list" role; otherwise, use the "listbox" role.
 * @param {?=} options An object that contains one or more property/value pairs to apply to the new control. Each property of the options object corresponds to one of the control's properties or events.
 * 
 */
WinJS.UI.ItemContainer = function(element, options) {};
 /** @type {boolean} */
WinJS.UI.ItemContainer.prototype.draggable;
 /** @type {!HTMLElement} */
WinJS.UI.ItemContainer.prototype.element;
 /** @type {boolean} */
WinJS.UI.ItemContainer.prototype.selected;
 /** @type {boolean} */
WinJS.UI.ItemContainer.prototype.selectionDisabled;
 /** @type {WinJS.UI.Orientation} */
WinJS.UI.ItemContainer.prototype.swipeOrientation;
 /** @type {WinJS.UI.TapBehavior} */
WinJS.UI.ItemContainer.prototype.tapBehavior;
 ...
 * @return {void}
 */
WinJS.UI.ItemContainer.prototype.oninvoked = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.ItemContainer.prototype.onselectionchanged = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.ItemContainer.prototype.onselectionchanging = function(eventInfo) {};

/**
 * Registers an event handler for the specified event.
 * @param {string} eventName The name of the event to handle. Note that you drop the "on" when specifying the event name. For example, instead of specifying "onclick", you specify "click".
 * @param {!Function} eventHandler The event handler function to associate with the event.
 * @param {boolean=} useCapture Set to true to register the event handler for the capturing phase; otherwise, set to false to register the event handler for the bubbling phase.
 * 
 * @return {void}
 */
WinJS.UI.ItemContainer.prototype.addEventListener = function(eventName, eventHandler, useCapture) {};
 ...
 * 
 */
WinJS.UI.ItemContainer.prototype.dispatchEvent = function(type, eventProperties) {};
 ...
 * @return {void}
 */
WinJS.UI.ItemContainer.prototype.dispose = function() {};
 ...
 * @return {void}
 */
WinJS.UI.ItemContainer.prototype.forceLayout = function() {};
 ...
 * @return {void}
 */
WinJS.UI.ItemContainer.prototype.removeEventListener = function(eventName, eventCallback, useCapture) {};
/**
 * @constructor
 * @struct
 */
...
WinJS.UI.ListLayout.prototype.itemInfo;
 /** @type {?} */
WinJS.UI.ListLayout.prototype.numberOfItemsPerItemsBlock;
 /** @type {WinJS.UI.Orientation} */
WinJS.UI.ListLayout.prototype.orientation;
 ...
 * @return {void}
 */
WinJS.UI.ListLayout.prototype.dragLeave = function() {};
 ...
 * @return {void}
 */
WinJS.UI.ListLayout.prototype.dragOver = function() {};
 ...
 * @return {void}
 */
WinJS.UI.ListLayout.prototype.executeAnimations = function() {};
 ...
 * 
 */
WinJS.UI.ListLayout.prototype.getAdjacent = function(currentItem, pressedKey) {};
 ...
 * @return {void}
 */
WinJS.UI.ListLayout.prototype.initialize = function() {};
 ...
 * @return {void}
 */
WinJS.UI.ListLayout.prototype.layout = function(tree, changedRange, modifiedItems, modifiedGroups) {};
 ...
 * @return {void}
 */
WinJS.UI.ListLayout.prototype.setupAnimations = function() {};
 ...
 * @return {void}
 */
WinJS.UI.ListLayout.prototype.uninitialize = function() {};
...
WinJS.UI.ListView.prototype.groupDataSource;
 /** @type {WinJS.UI.GroupHeaderTapBehavior} */
WinJS.UI.ListView.prototype.groupHeaderTapBehavior;
 /** @type {?} */
...
WinJS.UI.ListView.prototype.itemDataSource;
 /** @type {boolean} */
WinJS.UI.ListView.prototype.itemsReorderable;
 /** @type {?} */
WinJS.UI.ListView.prototype.itemTemplate;
 /** @type {!WinJS.UI.ILayout2} */
...
WinJS.UI.ListView.prototype.loadingState;
 /** @type {number} */
WinJS.UI.ListView.prototype.maxDeferredItemCleanup;
 /** @type {number} */
 ...
 * @param {!CustomEvent} eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.groupHeaderIndex, detail.groupHeaderPromise.
 * 
 * @return {void}
 */
WinJS.UI.ListView.prototype.ongroupheaderinvoked = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.ListView.prototype.dispose = function() {};
 ...
 * @struct
 * Creates a new Pivot.
 * @param {!HTMLElement=} element The DOM element hosts the new Pivot.
 * @param {?=} options An object that contains one or more property/value pairs to apply to the new control. Each property of the options object corresponds to one of the control's properties or events. Event names must begin with "on". For example, to provide a handler for the cancel event, add a property named "oncancel" to the options object and set its value to the event handler.
 * 
 */
WinJS.UI.Pivot = function(element, options) {};
 /** @type {!HTMLElement} */
WinJS.UI.Pivot.prototype.element;
 /** @type {!WinJS.Binding.List<!WinJS.UI.PivotItem>} */
WinJS.UI.Pivot.prototype.items;
 /** @type {boolean} */
WinJS.UI.Pivot.prototype.locked;
 /** @type {number} */
WinJS.UI.Pivot.prototype.selectedIndex;
 /** @type {!WinJS.UI.PivotItem} */
WinJS.UI.Pivot.prototype.selectedItem;
 /** @type {string} */
WinJS.UI.Pivot.prototype.title;
 ...
 * @return {void}
 */
WinJS.UI.Pivot.prototype.onitemanimationend = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.Pivot.prototype.onitemanimationstart = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.Pivot.prototype.onselectionchanged = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.Pivot.prototype.addEventListener = function(eventName, eventHandler, useCapture) {};
 ...
 * 
 */
WinJS.UI.Pivot.prototype.dispatchEvent = function(type, eventProperties) {};
 ...
 * @return {void}
 */
WinJS.UI.Pivot.prototype.dispose = function() {};
 ...
 * @return {void}
 */
WinJS.UI.Pivot.prototype.removeEventListener = function(eventName, eventCallback, useCapture) {};

/**
 * @constructor
 * @struct
 * Creates a new PivotItem.
 * @param {!HTMLElement=} element The DOM element hosts the new PivotItem.
 * @param {?=} options An object that contains one or more property/value pairs to apply to the new control. Each property of the options object corresponds to one of the control's properties or events. Event names must begin with "on". For example, to provide a handler for the cancel event, add a property named "oncancel" to the options object and set its value to the event handler.
 * 
 */
WinJS.UI.PivotItem = function(element, options) {};
 /** @type {!HTMLElement} */
WinJS.UI.PivotItem.prototype.contentElement;
 /** @type {!HTMLElement} */
WinJS.UI.PivotItem.prototype.element;
 /** @type {string} */
WinJS.UI.PivotItem.prototype.header;
 ...
 * @return {void}
 */
WinJS.UI.PivotItem.prototype.dispose = function() {};
 ...
 * 
 */
WinJS.UI.Repeater = function(element, options) {};
 /** @type {!WinJS.Binding.List<?>} */
WinJS.UI.Repeater.prototype.data;
 /** @type {!HTMLElement} */
WinJS.UI.Repeater.prototype.element;
 /** @type {number} */
WinJS.UI.Repeater.prototype.length;
 /** @type {!WinJS.Binding.Template} */
WinJS.UI.Repeater.prototype.template;
 ...
 * @param {!CustomEvent} eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.index, detail.key, detail.newElement, detail.newItem, detail.newValue, detail.oldElement, detail.oldItem, detail.oldValue, detail.setPromise.
 * 
 * @return {void}
 */
WinJS.UI.Repeater.prototype.onitemchanged = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.Repeater.prototype.onitemchanging = function(eventInfo) {};
 ...
 * @param {!CustomEvent} eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.affectedElement, detail.index, detail.key, detail.value.
 * 
 * @return {void}
 */
WinJS.UI.Repeater.prototype.oniteminserted = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.Repeater.prototype.oniteminserting = function(eventInfo) {};
 ...
 * @param {!CustomEvent} eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.affectedElement, detail.index, detail.key, detail.oldIndex, detail.newIndex.
 * 
 * @return {void}
 */
WinJS.UI.Repeater.prototype.onitemmoved = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.Repeater.prototype.onitemmoving = function(eventInfo) {};

/**
 * Raised after an item has been moved from one index to another in the Repeater control's data source and after the corresponding DOM element has been moved.
 * @param {!CustomEvent} eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.affectedElement, detail.index, detail.item, detail.setPromise.
 * 
 * @return {void}
 */
WinJS.UI.Repeater.prototype.onitemremoved = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.Repeater.prototype.onitemremoving = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.Repeater.prototype.onitemsloaded = function(eventInfo) {};

/**
 * Raised after the Repeater control's underlying data has been updated and after the updated HTML has been reloaded.
 * @param {!CustomEvent} eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.affectedElements.
 * 
 * @return {void}
 */
WinJS.UI.Repeater.prototype.onitemsreloaded = function(eventInfo) {};

/**
 * Raised after the Repeater control's underlying data has been updated but before the updated HTML has been reloaded.
 * @param {!CustomEvent} eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.affectedElements, detail.setPromise.
 * 
 * @return {void}
 */
WinJS.UI.Repeater.prototype.onitemsreloading = function(eventInfo) {};
 ...
 * @return {void}
 */
WinJS.UI.Repeater.prototype.addEventListener = function(eventName, eventHandler, useCapture) {};
 ...
 * 
 */
WinJS.UI.Repeater.prototype.dispatchEvent = function(type, eventProperties) {};
 ...
 * @return {void}
 */
WinJS.UI.Repeater.prototype.dispose = function() {};

/**
 * Returns the HTML element for the item at the specified index.
 * @param {number} index The index of the item.
 * @return {!HTMLElement} The DOM element for the specified item.
 * 
 */
WinJS.UI.Repeater.prototype.elementFromIndex = function(index) {};
 ...
 * @return {void}
 */
WinJS.UI.Repeater.prototype.removeEventListener = function(eventName, eventCallback, useCapture) {};
 ...
 * @return {void}
 */
WinJS.UI.SemanticZoom.prototype.dispose = function() {};
 ...
 * @return {void}
 */
WinJS.UI.TabContainer.prototype.dispose = function() {};
 ...
 * @return {void}
 */
WinJS.UI.ToggleSwitch.prototype.dispose = function() {};
 ...
 * @return {void}
 */
WinJS.UI.ViewBox.prototype.dispose = function() {};
 ...
 * @param {!HTMLElement} element Element to associate with the control.
 * @param {?} control The control to attach to the element.
 * 
 * @return {void}
 */
WinJS.UI.setControl = function(element, control) {};
 ...
 * @param {!HTMLElement} element The root element whose sub-tree is to be disposed.
 * 
 * @return {void}
 */
WinJS.Utilities.disposeSubTree = function(element) {};
 ...
 * @param {!HTMLElement} element The element to mark as disposable.
 * @param {!Function=} disposeImpl The function containing the element-specific dispose logic, called by the dispose function that markDisposable attaches.
 * 
 * @return {void}
 */
WinJS.Utilities.markDisposable = function(element, disposeImpl) {};
...
/** @const */
WinJS.Utilities.Scheduler.Priority = {};
/** @const {number} */
WinJS.Utilities.Scheduler.Priority.aboveNormal;
/** @const {number} */
WinJS.Utilities.Scheduler.Priority.belowNormal;
/** @const {number} */
 ...
 * @struct
 */
WinJS.Utilities.Scheduler.IJob = function() {};
 /** @type {boolean} */
WinJS.Utilities.Scheduler.IJob.prototype.completed;
 /** @type {number} */
WinJS.Utilities.Scheduler.IJob.prototype.id;
 /** @type {string} */
WinJS.Utilities.Scheduler.IJob.prototype.name;
 /** @type {!WinJS.Utilities.Scheduler.IOwnerToken} */
WinJS.Utilities.Scheduler.IJob.prototype.owner;
 /** @type {WinJS.Utilities.Scheduler.Priority} */
WinJS.Utilities.Scheduler.IJob.prototype.priority;
 ...
 * @return {void}
 */
WinJS.Utilities.Scheduler.IJob.prototype.cancel = function() {};
 ...
 * @return {void}
 */
WinJS.Utilities.Scheduler.IJob.prototype.pause = function() {};
 ...
 * @return {void}
 */
WinJS.Utilities.Scheduler.IJob.prototype.resume = function() {};
/**
 * @record
 * @struct
 */
WinJS.Utilities.Scheduler.IJobInfo = function() {};
 /** @type {!WinJS.Utilities.Scheduler.IJob} */
WinJS.Utilities.Scheduler.IJobInfo.prototype.job;
 /** @type {boolean} */
WinJS.Utilities.Scheduler.IJobInfo.prototype.shouldYield;

/**
 * Uses a Promise to determine how long the scheduler should wait before rescheduling the job after it yields.
 * @param {!WinJS.Promise<?>} promise Once the work item yields, the scheduler will wait for this Promise to complete before rescheduling the job.
 * 
 * @return {void}
 */
WinJS.Utilities.Scheduler.IJobInfo.prototype.setPromise = function(promise) {};

/**
 * Specifies the next unit of work to run once this job yields.
 * @param {!Function} work The next unit of work to run once this job yields.
 * 
 * @return {void}
 */
WinJS.Utilities.Scheduler.IJobInfo.prototype.setWork = function(work) {};
/**
 * @record
 * @struct
 */
WinJS.Utilities.Scheduler.IOwnerToken = function() {};
 ...
 * @return {void}
 */
WinJS.Utilities.Scheduler.IOwnerToken.prototype.cancelAll = function() {};
 /** @type {WinJS.Utilities.Scheduler.Priority} */
WinJS.Utilities.Scheduler.currentPriority;

/**
 * Creates and returns a new IOwnerToken which can be set to the owner property of one or more jobs.
 * @return {!WinJS.Utilities.Scheduler.IOwnerToken} A new IOwnerToken which can be set to the owner property of one or more jobs.
 * 
 */
 ...
 * @template U
 * @param {function(): U} callback The callback to run in a high priority callback.
 * @return {U} The return value of the callback.
 * 
 */
WinJS.Utilities.Scheduler.execHigh = function(callback) {};
 ...
 * @return {string} A string representation of the scheduler's state for diagnostic purposes. The jobs and drain requests are displayed in the order in which they are currently expected to be processed. The current job and drain request are marked by an asterisk.
 * 
 */
 ...
 * @param {WinJS.Utilities.Scheduler.Priority=} priority The priority to which the scheduler should drain. The default is -15.
 * @param {string=} name An optional description of the drain request for diagnostics.
 * @return {!WinJS.Promise<?>} A Promise which completes when the drain has finished. Canceling this Promise cancels the drain request. This Promise will never enter an error state.
 * 
 */
WinJS.Utilities.Scheduler.requestDrain = function(priority, name) {};

/**
 * Schedules the specified function to execute asynchronously.
 * @param {function(!WinJS.Utilities.Scheduler.IJobInfo): ?} work A function that represents the work item to be scheduled. When called the work item will receive as its first argument an object which allows the work item to ask the scheduler if it should yield cooperatively and if so allows the work item to either provide a function to be run as a continuation or a WinJS.Promise which will when complete provide a function to run as a continuation. Provide these fields for the object: shouldYield, setWork(work), setPromise(promise), job.
 * @param {WinJS.Utilities.Scheduler.Priority=} priority The priority of the work item. If you don't specify a priority, it defaults to WinJS.Utilities.Scheduler.Priority.normal.
 * @param {?=} thisArg A "this" instance to be bound to the work item. The default value is null.
 * @param {string=} name A description of the work item for diagnostics. The default value is an empty string.
 * @return {!WinJS.Utilities.Scheduler.IJob} The job instance that represents this work item.
 * 
 */
WinJS.Utilities.Scheduler.schedule = function(work, priority, thisArg, name) {};

/**
 * Schedules a job to complete the returned Promise at WinJS.Utilities.Scheduler.Priority.aboveNormal priority.
 * @template U
 * @param {U=} promiseValue The value returned by the completed Promise.
 * @param {string=} jobName A string that describes the job for diagnostic purposes.
 * @return {!WinJS.Promise<U>} A Promise that completes within a job of aboveNormal priority.
 * 
 */
WinJS.Utilities.Scheduler.schedulePromiseAboveNormal = function(promiseValue, jobName) {};
 ...
 * @param {U=} promiseValue The value returned by the completed Promise.
 * @param {string=} jobName A string that describes the job for diagnostic purposes.
 * @return {!WinJS.Promise<U>} A Promise that completes within a job of belowNormal priority.
 * 
 */
WinJS.Utilities.Scheduler.schedulePromiseBelowNormal = function(promiseValue, jobName) {};
 ...
 * @param {U=} promiseValue The value returned by the completed Promise.
 * @param {string=} jobName A string that describes the job for diagnostic purposes.
 * @return {!WinJS.Promise<U>} A Promise that completes within a job of high priority.
 * 
 */
WinJS.Utilities.Scheduler.schedulePromiseHigh = function(promiseValue, jobName) {};
 ...
 * @param {U=} promiseValue The value returned by the completed Promise.
 * @param {string=} jobName A string that describes the job for diagnostic purposes.
 * @return {!WinJS.Promise<U>} A Promise that completes within a job of idle priority.
 * 
 */
WinJS.Utilities.Scheduler.schedulePromiseIdle = function(promiseValue, jobName) {};
 ...
 * @param {U=} promiseValue The value returned by the completed Promise.
 * @param {string=} jobName A string that describes the job for diagnostic purposes.
 * @return {!WinJS.Promise<U>} A Promise that completes within a job of normal priority.
 * 
 */
WinJS.Utilities.Scheduler.schedulePromiseNormal = function(promiseValue, jobName) {};
