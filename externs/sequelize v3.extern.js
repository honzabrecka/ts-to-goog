...
// externs from d/sequelize v3/index.d.ts:
...
sequelize.InstanceIncrementDecrementOptions.prototype.transaction;
 /** @type {(!sequelize.WhereOptions|!Array<(string|!sequelize.col|!sequelize.and|!sequelize.or)>)} */
...
sequelize.WhereNested = function() {};
 /** @type {!Array<(!sequelize.WhereOptions|!sequelize.WhereLogic)>} */
 ...
 * @struct
 */
sequelize.WhereLogic = function() {};
 /** @type {(string|number|!sequelize.WhereLogic)} */
sequelize.WhereLogic.prototype.$ne;
 /** @type {(!Array<(string|number)>|!sequelize.literal)} */
sequelize.WhereLogic.prototype.$in;
 /** @type {(string|number|boolean|!sequelize.WhereOptions)} */
sequelize.WhereLogic.prototype.$not;
 /** @type {(!Array<(string|number)>|!sequelize.literal)} */
sequelize.WhereLogic.prototype.$notIn;
 /** @type {(string|number|!Date)} */
sequelize.WhereLogic.prototype.$gte;
 /** @type {(string|number|!Date)} */
sequelize.WhereLogic.prototype.$gt;
 /** @type {(string|number|!Date)} */
sequelize.WhereLogic.prototype.$lte;
 /** @type {(string|number|!Date)} */
sequelize.WhereLogic.prototype.$lt;
 /** @type {(string|!sequelize.WherePGStatement)} */
sequelize.WhereLogic.prototype.$like;
 /** @type {(string|!sequelize.WherePGStatement)} */
sequelize.WhereLogic.prototype.$iLike;
 /** @type {(string|!sequelize.WherePGStatement)} */
sequelize.WhereLogic.prototype.$ilike;
 /** @type {(string|!sequelize.WherePGStatement)} */
sequelize.WhereLogic.prototype.$notLike;
 /** @type {(string|!sequelize.WherePGStatement)} */
sequelize.WhereLogic.prototype.$notILike;
 /** @type {!Array<?>} */
sequelize.WhereLogic.prototype.$between;

/* TODO: PropertySignature: sequelize.".." */
 /** @type {!Array<?>} */
sequelize.WhereLogic.prototype.$notBetween;

/* TODO: PropertySignature: sequelize."!.." */
 /** @type {!Array<?>} */
sequelize.WhereLogic.prototype.$overlap;

/* TODO: PropertySignature: sequelize."&&" */
 /** @type {?} */
sequelize.WhereLogic.prototype.$contains;

/* TODO: PropertySignature: sequelize."@>" */
 /** @type {?} */
sequelize.WhereLogic.prototype.$contained;
 ...
 * @struct
 */
sequelize.WhereOptions = function() {};
...
sequelize.CountOptions = function() {};
 /** @type {(!sequelize.WhereOptions|!Array<string>)} */
...
sequelize.FindOrInitializeOptions = function() {};
 /** @type {(string|!sequelize.WhereOptions)} */
sequelize.FindOrInitializeOptions.prototype.where;
 /** @type {TAttributes} */
sequelize.FindOrInitializeOptions.prototype.defaults;
 /** @type {!sequelize.Transaction} */
sequelize.FindOrInitializeOptions.prototype.transaction;
/**
 * @record
 * @struct
 */
sequelize.FindCreateFindOptions = function() {};
 /** @type {(string|!sequelize.WhereOptions)} */
sequelize.FindCreateFindOptions.prototype.where;
 /** @type {TAttributes} */
 ...
 * ```
 * 
 * @param {(string|!sequelize.WhereOptions|!sequelize.ScopeOptions|!Array<(string|!sequelize.WhereOptions|!sequelize.ScopeOptions)>)=} options
 ...
 * @param {!sequelize.FindCreateFindOptions<TAttributes>} options
 * @return {!Bluebird<!Array<?>>}
 */
...
sequelize.DefineIndexesOptions.prototype.concurrently;
 /** @type {!Array<(string|!sequelize.fn|{attribute: string, length: number, order: string, collate: string})>} */
