 ...
 * @template U
 * @param {function(!Array<?>): (U|!PromiseLike<U>)} onFulfill
 * @param {function(?): (U|!PromiseLike<U>)=} onReject
 * @return {?<U>}
 */
...
/**
 * @template T
 * @param {function(!Array<?>): (T|!PromiseLike<T>)} method
 * @param {...?} args
...
/**
 * @template T
 * @param {function(!Array<?>): ?} nodeFunction
 * @param {...?} args
 * @return {function(!Array<?>): ?<T>}
 */
 ...
 * @param {(!Array<?>|!PromiseLike<!Array<?>>)|(!Array<(T|!PromiseLike<T>)>|!PromiseLike<!Array<(T|!PromiseLike<T>)>>)} promises
 ...
 * @template T
 * @param {(!Array<(T|!PromiseLike<T>)>|!PromiseLike<!Array<(T|!PromiseLike<T>)>>)} promises
 ...
 * @template T, U
 * @param {!Array<(T|!PromiseLike<T>)>} promises
 * @param {function(!Array<T>): (U|!PromiseLike<U>)} onFulfilled
 * @param {function(?): (U|!PromiseLike<U>)=} onRejected
 * @return {?<U>}
 */
 ...
 * @template T
 * @param {(T|?<T>)|number} promiseOrValue_or_ms
 * @param {number=} ms
 * @return {?<T>|?<void>}
 */
Q.delay = function(promiseOrValue_or_ms, ms) {};
...
/**
 * Returns whether a given promise is in the pending state. When the static version is used on non-promises, the result is always false.
 * @param {?} promiseOrObject
 * @return {boolean}
 */
Q.isPending = function(promiseOrObject) {};
...
/**
 * @template T
 * @param {function(function((T|!PromiseLike<T>)): void, function(?): void, function(?): void): void} resolver
 * @return {?<T>}
 */
