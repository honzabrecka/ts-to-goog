...
// externs from d/dsv/index.d.ts:
 /** @type {function(string, string): !_dsv.Dsv} */
var loader;
 ...
 * @template TRow
 * @param {string} table
 * @param {function(?): TRow=} accessor
 * @return {!Array<TRow>}
 */
_dsv.Dsv.prototype.parse = function(table, accessor) {};
 ...
 * @template TRow
 * @param {string} table
 * @param {function(!Array<string>): TRow=} accessor
 * @return {!Array<TRow>}
 */
_dsv.Dsv.prototype.parseRows = function(table, accessor) {};
 ...
 * @return {string}
 */
_dsv.Dsv.prototype.format = function(rows) {};
 ...
 * @return {string}
 */
_dsv.Dsv.prototype.formatRows = function(rows) {};
