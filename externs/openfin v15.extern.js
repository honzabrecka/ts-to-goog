...
// externs from d/openfin v15/index.d.ts:
/** @const */
var fin = {};
...
fin.WindowOptions = function() {};
 /** @type {{devtools: boolean, zoom: boolean}} */
...
fin.ExternalProcessLaunchInfo.prototype.arguments;
 /** @type {function({topic: string, uuid: string, exitCode: number}): void} */
fin.ExternalProcessLaunchInfo.prototype.listener;
...
fin.ExternalProcessInfo.prototype.pid;
 /** @type {function({topic: string, uuid: string, exitCode: number}): void} */
fin.ExternalProcessInfo.prototype.listener;
/**
 * @record
 * @struct
 */
