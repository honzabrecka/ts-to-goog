...
// externs from d/d3-brush/index.d.ts:
 ...
 * 
 * @param {?} group A D3 selection of SVG G elements. / A D3 transition on SVG G elements.
 * @param {null|!Array<?>|?} selection Use null to clear the active brush selection. / An array specifying the new active brush selection. For a two-dimensional brush,
 ...
 * for a y-brush, it must be defined as [y0, y1]. / A selection value function which is evaluated for each selected element,
 ...
 * @return {void}
 */
BrushBehavior.prototype.move = function(group, selection) {};
 ...
 * the brush selection cannot go outside the brush extent.
 * 
 * @param {!Array<?>|?=} extent array of points [[x0, y0], [x1, y1]], where [x0, y0] is the top-left corner
 * and [x1, y1] is the bottom-right corner. / An extent accessor function which is evaluated for each selected element,
 * in order, being passed the current datum (d), the current index (i), and the current group (nodes),
 ...
 * @return {?}
 */
BrushBehavior.prototype.extent = function(extent) {};
 ...
 * @return {?}
 */
BrushBehavior.prototype.filter = function(filterFn) {};
 ...
 * @return {number|?}
 */
BrushBehavior.prototype.handleSize = function(size) {};
 ...
 * @return {?}
 */
BrushBehavior.prototype.on = function(typenames, listener) {};
 ...
 * 
 * @param {!SVGGElement} node The node for which the brush selection should be returned.
 * @return {!Array<?>}
 */
 ...
 * @struct
 */
function D3BrushEvent() {}
 /** @type {?} */
D3BrushEvent.prototype.target;
 /** @type {string} */
D3BrushEvent.prototype.type;
 /** @type {!Array<?>} */
D3BrushEvent.prototype.selection;
 /** @type {?} */
D3BrushEvent.prototype.sourceEvent;
