...
// externs from d/devexpress-web v161/index.d.ts:
/**
 * @record
 * @struct
 */
 ...
 * @struct
 */
function ASPxClientDashboardDesigner() {}
 /** @type {!ASPxClientEvent<!ASPxClientDashboardStateChangedEventHandler<?>>} */
ASPxClientDashboardDesigner.prototype.DashboardStateChanged;
 /** @type {!ASPxClientEvent<!ASPxClientDashboardChangedEventHandler<?>>} */
ASPxClientDashboardDesigner.prototype.DashboardChanged;
 /** @type {!ASPxClientEvent<!ASPxClientDashboardDesignerCustomizeMenuItemsEventHandler<?>>} */
ASPxClientDashboardDesigner.prototype.CustomizeMenuItems;
 /** @type {!ASPxClientEvent<!ASPxClientDashboardDesignerBeforeRenderEventHandler<?>>} */
ASPxClientDashboardDesigner.prototype.BeforeRender;

/**
 * Switches the ASPxClientDashboardDesigner to the viewer mode.
 * @return {void}
 */
ASPxClientDashboardDesigner.prototype.SwitchToViewer = function() {};

/**
 * Switches the ASPxClientDashboardDesigner to the designer mode.
 * @return {void}
 */
ASPxClientDashboardDesigner.prototype.SwitchToDesigner = function() {};

/**
 * Gets the current working mode of the Web Designer.
 * @return {string}
 */
ASPxClientDashboardDesigner.prototype.GetWorkingMode = function() {};

/**
 * Gets the identifier of the dashboard that is displayed in the ASPxClientDashboardDesigner.
 * @return {string}
 */
ASPxClientDashboardDesigner.prototype.GetDashboardId = function() {};

/**
 * Gets the name of the dashboard that is displayed in the ASPxClientDashboardDesigner.
 * @return {string}
 */
ASPxClientDashboardDesigner.prototype.GetDashboardName = function() {};

/**
 * Gets the state of the dashboard (for instance, the master filtering state) displayed in the ASPxClientDashboardDesigner.
 * @return {string}
 */
ASPxClientDashboardDesigner.prototype.GetDashboardState = function() {};
 ...
 * @return {void}
 */
ASPxClientDashboardDesigner.prototype.LoadDashboard = function(dashboardId) {};

/**
 * Saves a dashboard to the dashboard storage.
 * @return {void}
 */
ASPxClientDashboardDesigner.prototype.SaveDashboard = function() {};
/**
 * @record
 * @struct
 */
 ...
 * @struct
 */
function ASPxClientDashboardDesignerCustomizeMenuItemsEventHandler() {}
 ...
 * @struct
 */
function ASPxClientDashboardDesignerMenuItem() {}
 /** @type {string} */
ASPxClientDashboardDesignerMenuItem.prototype.id;
 /** @type {string} */
ASPxClientDashboardDesignerMenuItem.prototype.title;
 /** @type {string} */
ASPxClientDashboardDesignerMenuItem.prototype.template;
 /** @type {boolean} */
ASPxClientDashboardDesignerMenuItem.prototype.selected;
 /** @type {boolean} */
ASPxClientDashboardDesignerMenuItem.prototype.disabled;
 /** @type {boolean} */
ASPxClientDashboardDesignerMenuItem.prototype.hasSeparator;
 /** @type {!Function} */
ASPxClientDashboardDesignerMenuItem.prototype.click;
 /** @type {number} */
ASPxClientDashboardDesignerMenuItem.prototype.hotKey;
/**
 * @extends {ASPxClientEventArgs}
 * @record
 * @struct
 */
function ASPxClientDashboardDesignerCustomizeMenuItemsEventArgs() {}
 /** @type {!Array<!ASPxClientDashboardDesignerMenuItem>} */
ASPxClientDashboardDesignerCustomizeMenuItemsEventArgs.prototype.Items;

/**
 * @param {string} itemId
 * @return {!ASPxClientDashboardDesignerMenuItem}
 */
ASPxClientDashboardDesignerCustomizeMenuItemsEventArgs.prototype.FindById = function(itemId) {};
/**
 * @record
 * @struct
 */
function ASPxClientDashboardDesignerBeforeRenderEventHandler() {}
 ...
 * @param {!ASPxClientDashboardRangeFilterSelection|string} range_or_dateTimePeriodName A String value that specifies the component name of the Range Filter dashboard item. / A String that specifies the name of the predefined range used to perform a selection.
 * @return {void}
 */
ASPxClientDashboardViewer.prototype.SetRange = function(itemName, range_or_dateTimePeriodName) {};
 ...
 * @return {void}
 */
ASPxClientDashboardViewer.prototype.ExportDashboardItemToPdf = function(itemName, options) {};
 ...
 * @return {void}
 */
ASPxClientDashboardViewer.prototype.ExportDashboardItemToImage = function(itemName, options) {};
 ...
 * @return {void}
 */
ASPxClientDashboardViewer.prototype.ExportDashboardItemToExcel = function(itemName, options) {};
 ...
 * @param {!Object} value The current parameter value.
 * @return {void}
 */
...
ASPxClientDashboardDrillDownPerformedEventArgs.prototype.ItemName;
 /** @type {!Array<!Object>} */
ASPxClientDashboardDrillDownPerformedEventArgs.prototype.Value;
 ...
 * @return {string}
 */
ASPxClientCardView.prototype.GetEditValue = function(column_or_columnIndex_or_columnFieldNameOrId) {};
/**
 ...
 * @param {boolean=} moveBefore true to move the column before the target column; otherwise, false.
 * @param {boolean=} moveToGroup true to group the grid's data by the column; otherwise, false. / true to group the ASPxGridView's data by the column; otherwise, false.
 * @param {boolean=} moveFromGroup true to ungroup the grid's data by the column; otherwise, false.
 * @return {void}
 */
ASPxClientGridView.prototype.MoveColumn = function(column_or_columnIndex_or_columnFieldNameOrId, moveToColumnVisibleIndex, moveBefore, moveToGroup, moveFromGroup) {};
...
function ASPxClientAppointmentDragEventArgs() {}
 /** @type {boolean} */
ASPxClientAppointmentDragEventArgs.prototype.handled;
 /** @type {!ASPxClientAppointmentOperation} */
ASPxClientAppointmentDragEventArgs.prototype.operation;
 ...
 * @struct
 */
function ASPxClientQueryBuilderMenuAction() {}
 /** @type {string} */
ASPxClientQueryBuilderMenuAction.prototype.text;
 /** @type {string} */
ASPxClientQueryBuilderMenuAction.prototype.imageClassName;
 /** @type {!Function} */
ASPxClientQueryBuilderMenuAction.prototype.clickAction;
 /** @type {boolean} */
ASPxClientQueryBuilderMenuAction.prototype.disabled;
 /** @type {boolean} */
ASPxClientQueryBuilderMenuAction.prototype.visible;
 /** @type {string} */
ASPxClientQueryBuilderMenuAction.prototype.hotKey;
 /** @type {string} */
ASPxClientQueryBuilderMenuAction.prototype.hasSeparator;
 /** @type {string} */
ASPxClientQueryBuilderMenuAction.prototype.container;
/**
 * @extends {ASPxClientEventArgs}
 * @record
 * @struct
 */
function ASPxClientQueryBuilderCustomizeToolbarActionsEventArgs() {}
 /** @type {!Array<!ASPxClientQueryBuilderMenuAction>} */
ASPxClientQueryBuilderCustomizeToolbarActionsEventArgs.prototype.Actions;

/**
 * Returns a menu action with the specified ID.
 * @param {string} actionId A String value, specifying the action ID.
 * @return {!ASPxClientQueryBuilderMenuAction}
 */
ASPxClientQueryBuilderCustomizeToolbarActionsEventArgs.prototype.GetById = function(actionId) {};
/**
 * @record
 * @struct
 */
 ...
 * @struct
 */
function ASPxClientReportDesignerMenuAction() {}
 /** @type {string} */
ASPxClientReportDesignerMenuAction.prototype.text;
 /** @type {string} */
ASPxClientReportDesignerMenuAction.prototype.imageClassName;
 /** @type {!Function} */
ASPxClientReportDesignerMenuAction.prototype.clickAction;
 /** @type {boolean} */
ASPxClientReportDesignerMenuAction.prototype.disabled;
 /** @type {boolean} */
ASPxClientReportDesignerMenuAction.prototype.visible;
 /** @type {string} */
ASPxClientReportDesignerMenuAction.prototype.hotKey;
 /** @type {string} */
ASPxClientReportDesignerMenuAction.prototype.hasSeparator;
 /** @type {string} */
ASPxClientReportDesignerMenuAction.prototype.container;
/**
 * @extends {ASPxClientEventArgs}
 * @record
 * @struct
 */
function ASPxClientReportDesignerCustomizeMenuActionsEventArgs() {}
 /** @type {!Array<!ASPxClientReportDesignerMenuAction>} */
ASPxClientReportDesignerCustomizeMenuActionsEventArgs.prototype.Actions;

/**
 * Returns a menu action with the specified ID.
 * @param {string} actionId A String value, specifying the action ID.
 * @return {!ASPxClientReportDesignerMenuAction}
 */
ASPxClientReportDesignerCustomizeMenuActionsEventArgs.prototype.GetById = function(actionId) {};
/**
 * @extends {ASPxClientEventArgs}
 * @record
 * @struct
 ...
 * @struct
 */
function ASPxClientWebDocumentViewerMenuAction() {}
 /** @type {string} */
ASPxClientWebDocumentViewerMenuAction.prototype.text;
 /** @type {string} */
ASPxClientWebDocumentViewerMenuAction.prototype.imageClassName;
 /** @type {!Function} */
ASPxClientWebDocumentViewerMenuAction.prototype.clickAction;
 /** @type {boolean} */
ASPxClientWebDocumentViewerMenuAction.prototype.disabled;
 /** @type {boolean} */
ASPxClientWebDocumentViewerMenuAction.prototype.visible;
 /** @type {string} */
ASPxClientWebDocumentViewerMenuAction.prototype.hotKey;
 /** @type {string} */
ASPxClientWebDocumentViewerMenuAction.prototype.hasSeparator;
 /** @type {string} */
ASPxClientWebDocumentViewerMenuAction.prototype.container;
/**
 * @extends {ASPxClientEventArgs}
 * @record
 * @struct
 */
function ASPxClientWebDocumentViewerCustomizeMenuActionsEventArgs() {}
 /** @type {!Array<!ASPxClientWebDocumentViewerMenuAction>} */
ASPxClientWebDocumentViewerCustomizeMenuActionsEventArgs.prototype.Actions;

/**
 * Returns a menu action with the specified ID.
 * @param {string} actionId A String value, specifying the action ID.
 * @return {!ASPxClientWebDocumentViewerMenuAction}
 */
ASPxClientWebDocumentViewerCustomizeMenuActionsEventArgs.prototype.GetById = function(actionId) {};
/**
 * @record
 * @struct
 */
 ...
 * @struct
 */
function ASPxClientDashboardDesignerStatic() {}
/**
 * @extends {ASPxClientControlStatic}
 * @record
 * @struct
...
var DashboardSpecialValues;
 /** @type {!ASPxClientDashboardDesignerStatic} */
var ASPxClientDashboardDesigner;
